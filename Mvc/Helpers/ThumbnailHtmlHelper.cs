...
namespace Araye.Code.Mvc.Helpers
{
	public static class ThumbnailHtmlHelper
	{
        ...
        public static MvcHtmlString Thumbnail(this HtmlHelper helper, string image, string baseFolderName,  string alias, object htmlAttributes)
        {
            ...
            TagBuilder img = GetThumbnailTagWithCustomBaseFolder(helper, requestedAlias.FolderName,baseFolderName, image, requestedAlias.Width, requestedAlias.Height);
        ...
        private static TagBuilder GetThumbnailTagWithCustomBaseFolder(HtmlHelper helper, string folderName, string baseFolder, string image, int width, int height)
        {
            TagBuilder img = new TagBuilder("img");
            bool originalMissing = false;

            //the physical path to the directory defined in baseImagePath in web.config
            String baseImagePhysicalPath = helper.ViewContext.HttpContext.Server.MapPath(baseFolder); 
            ...
            String virtualThumbnailPath = String.Concat(VirtualPathUtility.ToAbsolute(baseFolder),
